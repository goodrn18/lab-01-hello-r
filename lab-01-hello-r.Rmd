...
The star data has a similar correlation to the dino data, only differing by thousandths.
...
### Exercise 4
The circle data set has a slightly stronger correlation, however still only differs by a couple thousandths.
